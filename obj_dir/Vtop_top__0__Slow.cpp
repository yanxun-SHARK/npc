...
VL_ATTR_COLD void Vtop_top___ctor_var_reset(Vtop_top* vlSelf) {
    ...
    vlSelf->__PVT__csr_waddr = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 7347808842701014756ull);
    vlSelf->__PVT__csr_raddr = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 17848086834327152458ull);
    vlSelf->__PVT__ecall = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14585600130343804368ull);
    ...
    vlSelf->__PVT__my_CSR__DOT__MCYCLE_reg = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 10876926978575486008ull);
    vlSelf->__PVT__my_CSR__DOT__MCYCLEH_reg = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 17365752047688291073ull);
    vlSelf->__PVT__my_CSR__DOT__MSTATUS_reg = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 7228542681956099469ull);
    vlSelf->__PVT__my_CSR__DOT__MEPC_reg = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 10007400733844320320ull);
    vlSelf->__PVT__my_CSR__DOT__MCAUSE_reg = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 2348789131900605783ull);
    vlSelf->__PVT__my_CSR__DOT__MTVEC_reg = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 7250535107369490380ull);
    vlSelf->__Vfunc_my_LSU__DOT__pmem_read__1__Vfuncout = 0;
